...
const CartSummery = () => {
  ...
  return (
    <section className={styles.cartSummery}>
      <h1 className="headers text-yellow-400 mb-5 text-xl">Cart summery</h1>
      ...
      <Link
        ...
        className={`title text-yellow-400 mt-auto flex justify-center items-center rounded-md py-3 bg-gray-900`}
      >
        go to checkout
      </Link>
    </section>
